...
def generate_configuration_name_rr(configuaration_array):
    ...
    try:
        ...
        for index, item in enumerate(configuaration_array):
            ...
            return_val_of_try = generate_configuration_name_rr(item)
            # print(f"\n\n\n|||||||||||||||||||||||||||||||||||||End recursion {item}")
...
def generate_configuration_name(configuaration_array):
    ...
    return generate_configuration_name_rr(configuaration_array)

    
def main():
    config =[[[[2,2], [2,2], [2,2], [2,2]], [[2,2], [2,2], [2,2], [2,2]], [[2,2], [2,2], [2,2], [2,2]], [[2,2], [2,2], [2,2], [2,2]]], [[[2,2], [2,2], [2,2], [2,2]], [[2,2], [2,2], [2,2], [2,2]], [[2,2], [2,2], [2,2], [2,2]], [[2,2], [2,2], [2,2], [2,2]]], [[[2,2], [2,2], [2,2], [2,2]], [[2,2], [2,2], [2,2], [2,2]], [[2,2], [2,2], [2,2], [2,2]], [[2,2], [2,2], [2,2], [2,2]]], [[[2,2], [2,2], [2,2], [2,2]], [[2,2], [2,2], [2,2], [2,2]], [[2,2], [2,2], [2,2], [2,2]], [[2,2], [2,2], [2,2], [2,2]]]]
