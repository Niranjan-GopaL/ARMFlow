...
read_verilog ./custom/multiplier8bit.v 


#identify the top module name
link_design multiplier8bit
...
#estimate power
report_power >> ./custom/result_multiplier8bit.txt
...
#critical path delay
report_checks -unconstrained >> ./custom/result_multiplier8bit.txt
#----------------estimating critical path delay -------------------
