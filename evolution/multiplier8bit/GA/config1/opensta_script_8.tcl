...
read_verilog ../evolution/multiplier8bit/GA/config1/multiplier8bit_8.v 
...
#estimate power
report_power >> ../evolution/multiplier8bit/GA/config1/multiplier8bit_result_8.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier8bit/GA/config1/multiplier8bit_result_8.txt
#----------------estimating critical path delay -------------------
