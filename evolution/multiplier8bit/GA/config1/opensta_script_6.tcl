...
read_verilog ../evolution/multiplier8bit/GA/config1/multiplier8bit_6.v 
...
#estimate power
report_power >> ../evolution/multiplier8bit/GA/config1/multiplier8bit_result_6.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier8bit/GA/config1/multiplier8bit_result_6.txt
#----------------estimating critical path delay -------------------
