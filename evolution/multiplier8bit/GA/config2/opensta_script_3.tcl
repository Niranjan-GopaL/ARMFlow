...
read_verilog ../evolution/multiplier8bit/GA/config2/multiplier8bit_3.v 
...
#estimate power
report_power >> ../evolution/multiplier8bit/GA/config2/multiplier8bit_result_3.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier8bit/GA/config2/multiplier8bit_result_3.txt
#----------------estimating critical path delay -------------------
