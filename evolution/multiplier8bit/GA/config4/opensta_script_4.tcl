...
#estimate power
report_power >> ../evolution/multiplier8bit/GA/config4/multiplier8bit_result_4.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier8bit/GA/config4/multiplier8bit_result_4.txt
#----------------estimating critical path delay -------------------
