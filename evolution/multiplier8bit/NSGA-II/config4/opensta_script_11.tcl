...
read_verilog ../evolution/multiplier8bit/NSGA-II/config4/multiplier8bit_11.v 


#identify the top module name
link_design multiplier8bit_11
...
#estimate power
report_power >> ../evolution/multiplier8bit/NSGA-II/config4/multiplier8bit_result_11.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier8bit/NSGA-II/config4/multiplier8bit_result_11.txt
#----------------estimating critical path delay -------------------
