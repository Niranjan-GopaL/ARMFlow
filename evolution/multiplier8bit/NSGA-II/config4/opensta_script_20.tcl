...
#estimate power
report_power >> ../evolution/multiplier8bit/NSGA-II/config4/multiplier8bit_result_20.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier8bit/NSGA-II/config4/multiplier8bit_result_20.txt
#----------------estimating critical path delay -------------------
