...
read_verilog ../evolution/multiplier8bit/NSGA-II/config3/multiplier8bit_1.v 
...
#estimate power
report_power >> ../evolution/multiplier8bit/NSGA-II/config3/multiplier8bit_result_1.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier8bit/NSGA-II/config3/multiplier8bit_result_1.txt
#----------------estimating critical path delay -------------------
