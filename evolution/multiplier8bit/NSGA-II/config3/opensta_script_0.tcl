...
read_verilog ../evolution/multiplier8bit/NSGA-II/config3/multiplier8bit_0.v 


#identify the top module name
link_design multiplier8bit_0
...
#estimate power
report_power >> ../evolution/multiplier8bit/NSGA-II/config3/multiplier8bit_result_0.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier8bit/NSGA-II/config3/multiplier8bit_result_0.txt
#----------------estimating critical path delay -------------------
