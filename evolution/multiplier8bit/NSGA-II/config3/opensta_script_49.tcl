...
read_verilog ../evolution/multiplier8bit/NSGA-II/config3/multiplier8bit_49.v 


#identify the top module name
link_design multiplier8bit_49
...
#estimate power
report_power >> ../evolution/multiplier8bit/NSGA-II/config3/multiplier8bit_result_49.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier8bit/NSGA-II/config3/multiplier8bit_result_49.txt
#----------------estimating critical path delay -------------------
