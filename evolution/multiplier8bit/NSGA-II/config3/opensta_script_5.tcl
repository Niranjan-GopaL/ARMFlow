...
#estimate power
report_power >> ../evolution/multiplier8bit/NSGA-II/config3/multiplier8bit_result_5.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier8bit/NSGA-II/config3/multiplier8bit_result_5.txt
#----------------estimating critical path delay -------------------
