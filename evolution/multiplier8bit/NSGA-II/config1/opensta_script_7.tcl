...
read_verilog ../evolution/multiplier8bit/NSGA-II/config1/multiplier8bit_7.v 
...
#estimate power
report_power >> ../evolution/multiplier8bit/NSGA-II/config1/multiplier8bit_result_7.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier8bit/NSGA-II/config1/multiplier8bit_result_7.txt
#----------------estimating critical path delay -------------------
