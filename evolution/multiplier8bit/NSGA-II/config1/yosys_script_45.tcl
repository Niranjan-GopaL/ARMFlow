...
read_verilog -overwrite ../circuits/multiplier8bit/NSGA-II/config1/multiplier8bit_45.v

hierarchy -check -top multiplier8bit_45

#store the area result in a file
tee -q -o ../evolution/multiplier8bit/NSGA-II/config1/multiplier8bit_result_45.txt stat -liberty ../libFiles/ASAP_7nm_RVT_TT.lib
