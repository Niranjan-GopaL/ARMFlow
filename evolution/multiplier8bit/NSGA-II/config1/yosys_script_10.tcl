...
read_verilog -overwrite ../circuits/multiplier8bit/NSGA-II/config1/multiplier8bit_10.v

hierarchy -check -top multiplier8bit_10

#store the area result in a file
tee -q -o ../evolution/multiplier8bit/NSGA-II/config1/multiplier8bit_result_10.txt stat -liberty ../libFiles/ASAP_7nm_RVT_TT.lib
