...
read_verilog ../evolution/multiplier8bit/NSGA-II/config1/multiplier8bit_4.v 


#identify the top module name
link_design multiplier8bit_4
...
#estimate power
report_power >> ../evolution/multiplier8bit/NSGA-II/config1/multiplier8bit_result_4.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier8bit/NSGA-II/config1/multiplier8bit_result_4.txt
#----------------estimating critical path delay -------------------
