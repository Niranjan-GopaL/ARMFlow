...
read_verilog -overwrite ../evolution/multiplier8bit/NSGA-II/config1/multiplier8bit_2.v

hierarchy -check -top multiplier8bit_2

#store the area result in a file
tee -q -o ../evolution/multiplier8bit/NSGA-II/config1/multiplier8bit_result_2.txt stat -liberty ../libFiles/ASAP_7nm_RVT_TT.lib
