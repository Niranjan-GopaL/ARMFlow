...
read_verilog ../evolution/multiplier8bit/NSGA-II/config2/multiplier8bit_2.v 


#identify the top module name
link_design multiplier8bit_2
...
#estimate power
report_power >> ../evolution/multiplier8bit/NSGA-II/config2/multiplier8bit_result_2.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier8bit/NSGA-II/config2/multiplier8bit_result_2.txt
#----------------estimating critical path delay -------------------
