...
read_verilog ../evolution/multiplier8bit/NSGA-II/config2/multiplier8bit_21.v 


#identify the top module name
link_design multiplier8bit_21
...
#estimate power
report_power >> ../evolution/multiplier8bit/NSGA-II/config2/multiplier8bit_result_21.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier8bit/NSGA-II/config2/multiplier8bit_result_21.txt
#----------------estimating critical path delay -------------------
