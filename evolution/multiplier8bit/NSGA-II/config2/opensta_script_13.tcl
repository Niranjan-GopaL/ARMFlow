...
#estimate power
report_power >> ../evolution/multiplier8bit/NSGA-II/config2/multiplier8bit_result_13.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier8bit/NSGA-II/config2/multiplier8bit_result_13.txt
#----------------estimating critical path delay -------------------
