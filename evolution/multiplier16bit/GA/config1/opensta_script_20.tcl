...
read_verilog ../modules/netlist/NR_13_13.v
...
read_verilog ../evolution/multiplier16bit/GA/config1/multiplier16bit_20.v 
...
#estimate power
report_power >> ../evolution/multiplier16bit/GA/config1/multiplier16bit_result_20.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier16bit/GA/config1/multiplier16bit_result_20.txt
#----------------estimating critical path delay -------------------
