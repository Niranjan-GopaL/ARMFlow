...
read_verilog ../evolution/multiplier16bit/GA/config1/multiplier16bit_39.v 


#identify the top module name
link_design multiplier16bit_39
...
#estimate power
report_power >> ../evolution/multiplier16bit/GA/config1/multiplier16bit_result_39.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier16bit/GA/config1/multiplier16bit_result_39.txt
#----------------estimating critical path delay -------------------
