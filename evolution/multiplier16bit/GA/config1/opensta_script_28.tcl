...
read_verilog ../evolution/multiplier16bit/GA/config1/multiplier16bit_28.v 


#identify the top module name
link_design multiplier16bit_28
...
#estimate power
report_power >> ../evolution/multiplier16bit/GA/config1/multiplier16bit_result_28.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier16bit/GA/config1/multiplier16bit_result_28.txt
#----------------estimating critical path delay -------------------
