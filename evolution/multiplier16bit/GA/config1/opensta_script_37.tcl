...
read_verilog ../modules/netlist/customAdder16_2.v
read_verilog ../modules/netlist/customAdder19_2.v
read_verilog ../modules/netlist/customAdder5_2.v

read_verilog ../evolution/multiplier16bit/GA/config1/multiplier16bit_37.v 
...
#estimate power
report_power >> ../evolution/multiplier16bit/GA/config1/multiplier16bit_result_37.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier16bit/GA/config1/multiplier16bit_result_37.txt
#----------------estimating critical path delay -------------------
