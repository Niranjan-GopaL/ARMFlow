...
read_verilog -overwrite ../evolution/multiplier16bit/GA/config1/multiplier16bit_27.v

hierarchy -check -top multiplier16bit_27

#store the area result in a file
tee -q -o ../evolution/multiplier16bit/GA/config1/multiplier16bit_result_27.txt stat -liberty ../libFiles/ASAP_7nm_RVT_TT.lib
