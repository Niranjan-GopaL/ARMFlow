...
read_verilog ../modules/netlist/NR_5_8.v
...
read_verilog ../modules/netlist/NR_8_5.v
read_verilog ../modules/netlist/customAdder18_4.v
...
read_verilog ../evolution/multiplier16bit/GA/config1/multiplier16bit_13.v 
...
#estimate power
report_power >> ../evolution/multiplier16bit/GA/config1/multiplier16bit_result_13.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier16bit/GA/config1/multiplier16bit_result_13.txt
#----------------estimating critical path delay -------------------
