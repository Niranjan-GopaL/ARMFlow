...
read_verilog ../modules/netlist/NR_11_11.v
...
read_verilog ../evolution/multiplier16bit/GA/config1/multiplier16bit_5.v 


#identify the top module name
link_design multiplier16bit_5
...
#estimate power
report_power >> ../evolution/multiplier16bit/GA/config1/multiplier16bit_result_5.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier16bit/GA/config1/multiplier16bit_result_5.txt
#----------------estimating critical path delay -------------------
