...
read_verilog ../modules/netlist/NR_4_9.v
...
read_verilog ../modules/netlist/NR_9_4.v
read_verilog ../modules/netlist/customAdder22_8.v
...
read_verilog ../evolution/multiplier16bit/GA/config1/multiplier16bit_14.v 


#identify the top module name
link_design multiplier16bit_14
...
#estimate power
report_power >> ../evolution/multiplier16bit/GA/config1/multiplier16bit_result_14.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier16bit/GA/config1/multiplier16bit_result_14.txt
#----------------estimating critical path delay -------------------
