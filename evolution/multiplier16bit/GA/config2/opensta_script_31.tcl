...
read_verilog ../modules/netlist/NR_8_7.v
read_verilog ../modules/netlist/NR_1_1.v
read_verilog ../modules/netlist/NR_9_6.v
read_verilog ../modules/netlist/NR_2_6.v
read_verilog ../modules/netlist/NR_6_6.v
read_verilog ../modules/netlist/NR_6_9.v
read_verilog ../modules/netlist/NR_7_8.v
...
read_verilog ../modules/netlist/customAdder22_6.v
read_verilog ../modules/netlist/customAdder31_15.v
read_verilog ../modules/netlist/customAdder5_2.v

read_verilog ../evolution/multiplier16bit/GA/config2/multiplier16bit_31.v 


#identify the top module name
link_design multiplier16bit_31
...
#estimate power
report_power >> ../evolution/multiplier16bit/GA/config2/multiplier16bit_result_31.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier16bit/GA/config2/multiplier16bit_result_31.txt
#----------------estimating critical path delay -------------------
