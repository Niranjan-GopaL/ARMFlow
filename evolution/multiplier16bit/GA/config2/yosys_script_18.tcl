...
read_verilog -overwrite ../evolution/multiplier16bit/GA/config2/multiplier16bit_18.v

hierarchy -check -top multiplier16bit_18

#store the area result in a file
tee -q -o ../evolution/multiplier16bit/GA/config2/multiplier16bit_result_18.txt stat -liberty ../libFiles/ASAP_7nm_RVT_TT.lib
