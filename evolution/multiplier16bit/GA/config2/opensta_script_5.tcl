...
read_verilog ../modules/netlist/customAdder15_2.v

read_verilog ../evolution/multiplier16bit/GA/config2/multiplier16bit_5.v 
...
#estimate power
report_power >> ../evolution/multiplier16bit/GA/config2/multiplier16bit_result_5.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier16bit/GA/config2/multiplier16bit_result_5.txt
#----------------estimating critical path delay -------------------
