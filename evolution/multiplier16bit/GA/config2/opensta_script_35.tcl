...
read_verilog ../evolution/multiplier16bit/GA/config2/multiplier16bit_35.v 


#identify the top module name
link_design multiplier16bit_35
...
#estimate power
report_power >> ../evolution/multiplier16bit/GA/config2/multiplier16bit_result_35.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier16bit/GA/config2/multiplier16bit_result_35.txt
#----------------estimating critical path delay -------------------
