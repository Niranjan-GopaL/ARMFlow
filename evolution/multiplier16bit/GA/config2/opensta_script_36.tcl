...
read_verilog ../modules/netlist/customAdder21_4.v

read_verilog ../evolution/multiplier16bit/GA/config2/multiplier16bit_36.v 
...
#estimate power
report_power >> ../evolution/multiplier16bit/GA/config2/multiplier16bit_result_36.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier16bit/GA/config2/multiplier16bit_result_36.txt
#----------------estimating critical path delay -------------------
