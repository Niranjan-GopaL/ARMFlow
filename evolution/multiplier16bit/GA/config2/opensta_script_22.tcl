...
read_verilog ../modules/netlist/customAdder23_7.v
...
read_verilog ../evolution/multiplier16bit/GA/config2/multiplier16bit_22.v 


#identify the top module name
link_design multiplier16bit_22
...
#estimate power
report_power >> ../evolution/multiplier16bit/GA/config2/multiplier16bit_result_22.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier16bit/GA/config2/multiplier16bit_result_22.txt
#----------------estimating critical path delay -------------------
