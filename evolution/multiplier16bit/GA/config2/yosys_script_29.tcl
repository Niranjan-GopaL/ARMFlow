...
read_verilog -overwrite ../modules/netlist/customAdder17_5.v
read_verilog -overwrite ../modules/netlist/customAdder28_11.v
read_verilog -overwrite ../modules/netlist/customAdder23_11.v

read_verilog -overwrite ../evolution/multiplier16bit/GA/config2/multiplier16bit_29.v

hierarchy -check -top multiplier16bit_29

#store the area result in a file
tee -q -o ../evolution/multiplier16bit/GA/config2/multiplier16bit_result_29.txt stat -liberty ../libFiles/ASAP_7nm_RVT_TT.lib
