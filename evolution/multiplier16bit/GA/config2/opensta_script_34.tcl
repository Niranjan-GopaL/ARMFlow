...
read_verilog ../modules/netlist/customAdder21_5.v
read_verilog ../modules/netlist/customAdder6_0.v
read_verilog ../modules/netlist/customAdder5_2.v

read_verilog ../evolution/multiplier16bit/GA/config2/multiplier16bit_34.v 


#identify the top module name
link_design multiplier16bit_34
...
#estimate power
report_power >> ../evolution/multiplier16bit/GA/config2/multiplier16bit_result_34.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier16bit/GA/config2/multiplier16bit_result_34.txt
#----------------estimating critical path delay -------------------
