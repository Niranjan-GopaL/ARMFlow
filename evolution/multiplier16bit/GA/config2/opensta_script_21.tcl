...
read_verilog ../modules/netlist/customAdder20_5.v
...
read_verilog ../evolution/multiplier16bit/GA/config2/multiplier16bit_21.v 
...
#estimate power
report_power >> ../evolution/multiplier16bit/GA/config2/multiplier16bit_result_21.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier16bit/GA/config2/multiplier16bit_result_21.txt
#----------------estimating critical path delay -------------------
