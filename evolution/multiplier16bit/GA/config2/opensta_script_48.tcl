...
read_verilog ../modules/netlist/NR_12_3.v
...
read_verilog ../modules/netlist/NR_3_12.v
read_verilog ../modules/netlist/NR_1_3.v
read_verilog ../modules/netlist/customAdder12_0.v
read_verilog ../modules/netlist/customAdder20_7.v
...
read_verilog ../modules/netlist/customAdder18_2.v
...
read_verilog ../evolution/multiplier16bit/GA/config2/multiplier16bit_48.v 


#identify the top module name
link_design multiplier16bit_48
...
#estimate power
report_power >> ../evolution/multiplier16bit/GA/config2/multiplier16bit_result_48.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier16bit/GA/config2/multiplier16bit_result_48.txt
#----------------estimating critical path delay -------------------
