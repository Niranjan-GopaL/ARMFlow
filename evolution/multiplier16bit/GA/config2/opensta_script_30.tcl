...
read_verilog ../evolution/multiplier16bit/GA/config2/multiplier16bit_30.v 


#identify the top module name
link_design multiplier16bit_30
...
#estimate power
report_power >> ../evolution/multiplier16bit/GA/config2/multiplier16bit_result_30.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier16bit/GA/config2/multiplier16bit_result_30.txt
#----------------estimating critical path delay -------------------
