...
read_verilog ../modules/netlist/customAdder17_5.v
read_verilog ../modules/netlist/customAdder28_11.v
read_verilog ../modules/netlist/customAdder23_11.v

read_verilog ../evolution/multiplier16bit/GA/config2/multiplier16bit_29.v 


#identify the top module name
link_design multiplier16bit_29
...
#estimate power
report_power >> ../evolution/multiplier16bit/GA/config2/multiplier16bit_result_29.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier16bit/GA/config2/multiplier16bit_result_29.txt
#----------------estimating critical path delay -------------------
