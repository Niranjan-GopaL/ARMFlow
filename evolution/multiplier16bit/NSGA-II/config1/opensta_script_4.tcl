...
read_verilog ../evolution/multiplier16bit/NSGA-II/config1/multiplier16bit_4.v 


#identify the top module name
link_design multiplier16bit_4
...
#estimate power
report_power >> ../evolution/multiplier16bit/NSGA-II/config1/multiplier16bit_result_4.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier16bit/NSGA-II/config1/multiplier16bit_result_4.txt
#----------------estimating critical path delay -------------------
