...
read_verilog -overwrite ../evolution/multiplier16bit/NSGA-II/config1/multiplier16bit_42.v

hierarchy -check -top multiplier16bit_42

#store the area result in a file
tee -q -o ../evolution/multiplier16bit/NSGA-II/config1/multiplier16bit_result_42.txt stat -liberty ../libFiles/ASAP_7nm_RVT_TT.lib
