...
read_verilog ../modules/netlist/customAdder27_11.v
...
read_verilog ../evolution/multiplier16bit/NSGA-II/config1/multiplier16bit_11.v 


#identify the top module name
link_design multiplier16bit_11
...
#estimate power
report_power >> ../evolution/multiplier16bit/NSGA-II/config1/multiplier16bit_result_11.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier16bit/NSGA-II/config1/multiplier16bit_result_11.txt
#----------------estimating critical path delay -------------------
