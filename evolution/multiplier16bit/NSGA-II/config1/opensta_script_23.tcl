...
read_verilog ../modules/netlist/customAdder16_4.v

read_verilog ../evolution/multiplier16bit/NSGA-II/config1/multiplier16bit_23.v 


#identify the top module name
link_design multiplier16bit_23
...
#estimate power
report_power >> ../evolution/multiplier16bit/NSGA-II/config1/multiplier16bit_result_23.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier16bit/NSGA-II/config1/multiplier16bit_result_23.txt
#----------------estimating critical path delay -------------------
