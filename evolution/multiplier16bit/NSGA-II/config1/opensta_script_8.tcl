...
read_verilog ../modules/netlist/customAdder18_5.v
read_verilog ../modules/netlist/customAdder5_2.v

read_verilog ../evolution/multiplier16bit/NSGA-II/config1/multiplier16bit_8.v 


#identify the top module name
link_design multiplier16bit_8
...
#estimate power
report_power >> ../evolution/multiplier16bit/NSGA-II/config1/multiplier16bit_result_8.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier16bit/NSGA-II/config1/multiplier16bit_result_8.txt
#----------------estimating critical path delay -------------------
