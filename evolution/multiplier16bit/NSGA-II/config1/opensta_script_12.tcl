...
read_verilog ../evolution/multiplier16bit/NSGA-II/config1/multiplier16bit_12.v 
...
#estimate power
report_power >> ../evolution/multiplier16bit/NSGA-II/config1/multiplier16bit_result_12.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier16bit/NSGA-II/config1/multiplier16bit_result_12.txt
#----------------estimating critical path delay -------------------
