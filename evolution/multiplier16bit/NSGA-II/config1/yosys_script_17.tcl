...
read_verilog -overwrite ../modules/netlist/customAdder19_4.v
...
read_verilog -overwrite ../evolution/multiplier16bit/NSGA-II/config1/multiplier16bit_17.v

hierarchy -check -top multiplier16bit_17

#store the area result in a file
tee -q -o ../evolution/multiplier16bit/NSGA-II/config1/multiplier16bit_result_17.txt stat -liberty ../libFiles/ASAP_7nm_RVT_TT.lib
