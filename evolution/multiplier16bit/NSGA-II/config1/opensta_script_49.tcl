...
read_verilog ../modules/netlist/customAdder29_12.v

read_verilog ../evolution/multiplier16bit/NSGA-II/config1/multiplier16bit_49.v 


#identify the top module name
link_design multiplier16bit_49
...
#estimate power
report_power >> ../evolution/multiplier16bit/NSGA-II/config1/multiplier16bit_result_49.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier16bit/NSGA-II/config1/multiplier16bit_result_49.txt
#----------------estimating critical path delay -------------------
