...
read_verilog ../evolution/multiplier16bit/NSGA-II/config1/multiplier16bit_38.v 


#identify the top module name
link_design multiplier16bit_38
...
#estimate power
report_power >> ../evolution/multiplier16bit/NSGA-II/config1/multiplier16bit_result_38.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier16bit/NSGA-II/config1/multiplier16bit_result_38.txt
#----------------estimating critical path delay -------------------
