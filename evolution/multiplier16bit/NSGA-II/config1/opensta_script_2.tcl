...
read_verilog ../modules/netlist/customAdder25_8.v
read_verilog ../modules/netlist/customAdder5_0.v

read_verilog ../evolution/multiplier16bit/NSGA-II/config1/multiplier16bit_2.v 


#identify the top module name
link_design multiplier16bit_2
...
#estimate power
report_power >> ../evolution/multiplier16bit/NSGA-II/config1/multiplier16bit_result_2.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier16bit/NSGA-II/config1/multiplier16bit_result_2.txt
#----------------estimating critical path delay -------------------
