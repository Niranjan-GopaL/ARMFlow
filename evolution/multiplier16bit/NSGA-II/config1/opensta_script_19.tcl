...
read_verilog ../modules/netlist/NR_6_5.v
...
read_verilog ../modules/netlist/NR_5_6.v
...
read_verilog ../modules/netlist/customAdder28_11.v

read_verilog ../evolution/multiplier16bit/NSGA-II/config1/multiplier16bit_19.v 


#identify the top module name
link_design multiplier16bit_19
...
#estimate power
report_power >> ../evolution/multiplier16bit/NSGA-II/config1/multiplier16bit_result_19.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier16bit/NSGA-II/config1/multiplier16bit_result_19.txt
#----------------estimating critical path delay -------------------
