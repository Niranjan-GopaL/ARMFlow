...
read_verilog ../modules/netlist/NR_1_12.v
...
read_verilog ../modules/netlist/NR_8_4.v
read_verilog ../modules/netlist/NR_12_1.v
...
read_verilog ../modules/netlist/NR_4_8.v
...
read_verilog ../modules/netlist/customAdder16_3.v
...
read_verilog ../modules/netlist/customAdder19_2.v
read_verilog ../modules/netlist/customAdder5_2.v

read_verilog ../evolution/multiplier16bit/NSGA-II/config1/multiplier16bit_20.v 


#identify the top module name
link_design multiplier16bit_20
...
#estimate power
report_power >> ../evolution/multiplier16bit/NSGA-II/config1/multiplier16bit_result_20.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier16bit/NSGA-II/config1/multiplier16bit_result_20.txt
#----------------estimating critical path delay -------------------
