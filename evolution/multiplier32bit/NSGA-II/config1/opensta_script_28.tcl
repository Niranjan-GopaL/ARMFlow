...
read_verilog ../modules/netlist/NR_5_17.v
read_verilog ../modules/netlist/NR_14_14.v
read_verilog ../modules/netlist/NR_27_5.v
read_verilog ../modules/netlist/NR_2_2.v
read_verilog ../modules/netlist/NR_14_3.v
read_verilog ../modules/netlist/NR_22_5.v
...
read_verilog ../modules/netlist/NR_17_5.v
read_verilog ../modules/netlist/NR_5_22.v
read_verilog ../modules/netlist/NR_3_14.v
...
read_verilog ../modules/netlist/customAdder39_16.v
...
read_verilog ../modules/netlist/customAdder49_21.v
read_verilog ../modules/netlist/customAdder32_0.v
read_verilog ../modules/netlist/customAdder31_13.v

read_verilog ../circuits/multiplier32bit/NSGA-II/config1/multiplier32bit_28.v 


#identify the top module name
link_design multiplier32bit_28
...
#estimate power
report_power >> ../evolution/multiplier32bit/NSGA-II/config1/multiplier32bit_result_28.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier32bit/NSGA-II/config1/multiplier32bit_result_28.txt
#----------------estimating critical path delay -------------------
