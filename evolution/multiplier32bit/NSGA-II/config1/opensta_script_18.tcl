...
read_verilog ../modules/netlist/NR_7_19.v
...
read_verilog ../modules/netlist/NR_19_7.v
...
read_verilog ../modules/netlist/customAdder33_6.v
...
read_verilog ../circuits/multiplier32bit/NSGA-II/config1/multiplier32bit_18.v 


#identify the top module name
link_design multiplier32bit_18
...
#estimate power
report_power >> ../evolution/multiplier32bit/NSGA-II/config1/multiplier32bit_result_18.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier32bit/NSGA-II/config1/multiplier32bit_result_18.txt
#----------------estimating critical path delay -------------------
