...
read_verilog ../modules/netlist/NR_6_23.v
read_verilog ../modules/netlist/NR_16_7.v
read_verilog ../modules/netlist/NR_7_16.v
read_verilog ../modules/netlist/NR_2_4.v
read_verilog ../modules/netlist/NR_23_6.v
...
read_verilog ../modules/netlist/customAdder35_5.v
...
read_verilog ../modules/netlist/customAdder39_15.v
read_verilog ../modules/netlist/customAdder29_0.v
read_verilog ../modules/netlist/customAdder32_0.v

read_verilog ../circuits/multiplier32bit/NSGA-II/config1/multiplier32bit_14.v 


#identify the top module name
link_design multiplier32bit_14
...
#estimate power
report_power >> ../evolution/multiplier32bit/NSGA-II/config1/multiplier32bit_result_14.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier32bit/NSGA-II/config1/multiplier32bit_result_14.txt
#----------------estimating critical path delay -------------------
