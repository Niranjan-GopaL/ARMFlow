...
read_verilog ../modules/netlist/NR_31_31.v
...
read_verilog ../circuits/multiplier32bit/NSGA-II/config1/multiplier32bit_45.v 


#identify the top module name
link_design multiplier32bit_45
...
#estimate power
report_power >> ../evolution/multiplier32bit/NSGA-II/config1/multiplier32bit_result_45.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier32bit/NSGA-II/config1/multiplier32bit_result_45.txt
#----------------estimating critical path delay -------------------
