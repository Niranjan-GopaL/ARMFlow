...
read_verilog -overwrite ../circuits/multiplier32bit/NSGA-II/config1/multiplier32bit_38.v

hierarchy -check -top multiplier32bit_38

#store the area result in a file
tee -q -o ../evolution/multiplier32bit/NSGA-II/config1/multiplier32bit_result_38.txt stat -liberty ../libFiles/ASAP_7nm_RVT_TT.lib
