...
read_verilog ../modules/netlist/NR_8_9.v
...
read_verilog ../modules/netlist/NR_9_8.v
...
read_verilog ../modules/netlist/customAdder49_16.v
...
read_verilog ../modules/netlist/customAdder26_8.v
...
read_verilog ../circuits/multiplier32bit/NSGA-II/config1/multiplier32bit_30.v 


#identify the top module name
link_design multiplier32bit_30
...
#estimate power
report_power >> ../evolution/multiplier32bit/NSGA-II/config1/multiplier32bit_result_30.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier32bit/NSGA-II/config1/multiplier32bit_result_30.txt
#----------------estimating critical path delay -------------------
