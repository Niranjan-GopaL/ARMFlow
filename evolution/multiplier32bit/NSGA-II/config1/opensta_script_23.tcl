...
read_verilog ../modules/netlist/NR_5_23.v
...
read_verilog ../modules/netlist/NR_23_5.v
...
read_verilog ../modules/netlist/customAdder33_4.v
...
read_verilog ../circuits/multiplier32bit/NSGA-II/config1/multiplier32bit_23.v 


#identify the top module name
link_design multiplier32bit_23
...
#estimate power
report_power >> ../evolution/multiplier32bit/NSGA-II/config1/multiplier32bit_result_23.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier32bit/NSGA-II/config1/multiplier32bit_result_23.txt
#----------------estimating critical path delay -------------------
