...
read_verilog ../modules/netlist/customAdder15_1.v
...
read_verilog ../modules/netlist/customAdder19_7.v
...
read_verilog ../circuits/multiplier32bit/NSGA-II/config1/multiplier32bit_13.v 


#identify the top module name
link_design multiplier32bit_13
...
#estimate power
report_power >> ../evolution/multiplier32bit/NSGA-II/config1/multiplier32bit_result_13.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier32bit/NSGA-II/config1/multiplier32bit_result_13.txt
#----------------estimating critical path delay -------------------
