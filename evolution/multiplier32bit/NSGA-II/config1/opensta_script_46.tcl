...
read_verilog ../modules/netlist/NR_30_30.v
read_verilog ../modules/netlist/NR_30_2.v
read_verilog ../modules/netlist/NR_2_30.v
read_verilog ../modules/netlist/NR_2_2.v
read_verilog ../modules/netlist/customAdder34_1.v
read_verilog ../modules/netlist/customAdder32_0.v

read_verilog ../circuits/multiplier32bit/NSGA-II/config1/multiplier32bit_46.v 


#identify the top module name
link_design multiplier32bit_46
...
#estimate power
report_power >> ../evolution/multiplier32bit/NSGA-II/config1/multiplier32bit_result_46.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier32bit/NSGA-II/config1/multiplier32bit_result_46.txt
#----------------estimating critical path delay -------------------
