...
read_verilog ../circuits/multiplier32bit/NSGA-II/config1/multiplier32bit_39.v 


#identify the top module name
link_design multiplier32bit_39
...
#estimate power
report_power >> ../evolution/multiplier32bit/NSGA-II/config1/multiplier32bit_result_39.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier32bit/NSGA-II/config1/multiplier32bit_result_39.txt
#----------------estimating critical path delay -------------------
