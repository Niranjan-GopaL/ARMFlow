...
read_verilog ../modules/netlist/NR_26_26.v
...
read_verilog ../circuits/multiplier32bit/NSGA-II/config1/multiplier32bit_40.v 


#identify the top module name
link_design multiplier32bit_40
...
#estimate power
report_power >> ../evolution/multiplier32bit/NSGA-II/config1/multiplier32bit_result_40.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier32bit/NSGA-II/config1/multiplier32bit_result_40.txt
#----------------estimating critical path delay -------------------
