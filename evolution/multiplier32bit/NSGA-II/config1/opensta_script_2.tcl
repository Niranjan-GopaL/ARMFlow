...
read_verilog ../modules/netlist/customAdder60_27.v
read_verilog ../modules/netlist/customAdder32_8.v
read_verilog ../modules/netlist/customAdder52_23.v
read_verilog ../modules/netlist/customAdder7_3.v
read_verilog ../modules/netlist/customAdder12_2.v
read_verilog ../modules/netlist/customAdder23_8.v
...
read_verilog ../evolution/multiplier32bit/NSGA-II/config1/multiplier32bit_2.v 


#identify the top module name
link_design multiplier32bit_2
...
#estimate power
report_power >> ../evolution/multiplier32bit/NSGA-II/config1/multiplier32bit_result_2.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier32bit/NSGA-II/config1/multiplier32bit_result_2.txt
#----------------estimating critical path delay -------------------
