...
read_verilog ../modules/netlist/NR_4_17.v
...
read_verilog ../modules/netlist/NR_17_17.v
read_verilog ../modules/netlist/NR_21_3.v
read_verilog ../modules/netlist/NR_5_24.v
read_verilog ../modules/netlist/NR_17_4.v
...
read_verilog ../modules/netlist/customAdder45_20.v
...
read_verilog ../modules/netlist/customAdder38_16.v
read_verilog ../modules/netlist/customAdder29_0.v
read_verilog ../modules/netlist/customAdder32_0.v

read_verilog ../circuits/multiplier32bit/NSGA-II/config1/multiplier32bit_27.v 


#identify the top module name
link_design multiplier32bit_27
...
#estimate power
report_power >> ../evolution/multiplier32bit/NSGA-II/config1/multiplier32bit_result_27.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier32bit/NSGA-II/config1/multiplier32bit_result_27.txt
#----------------estimating critical path delay -------------------
