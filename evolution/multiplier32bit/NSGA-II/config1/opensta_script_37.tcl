...
read_verilog ../modules/netlist/NR_9_15.v
read_verilog ../modules/netlist/NR_3_5.v
read_verilog ../modules/netlist/NR_3_2.v
read_verilog ../modules/netlist/NR_15_9.v
read_verilog ../modules/netlist/NR_2_2.v
read_verilog ../modules/netlist/NR_5_10.v
...
read_verilog ../modules/netlist/NR_10_5.v
...
read_verilog ../modules/netlist/customAdder39_14.v
...
read_verilog ../modules/netlist/customAdder25_9.v
read_verilog ../modules/netlist/customAdder32_0.v

read_verilog ../circuits/multiplier32bit/NSGA-II/config1/multiplier32bit_37.v 


#identify the top module name
link_design multiplier32bit_37
...
#estimate power
report_power >> ../evolution/multiplier32bit/NSGA-II/config1/multiplier32bit_result_37.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier32bit/NSGA-II/config1/multiplier32bit_result_37.txt
#----------------estimating critical path delay -------------------
