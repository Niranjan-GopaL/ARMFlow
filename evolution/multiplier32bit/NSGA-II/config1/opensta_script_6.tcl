...
read_verilog ../evolution/multiplier32bit/NSGA-II/config1/multiplier32bit_6.v 


#identify the top module name
link_design multiplier32bit_6
...
#estimate power
report_power >> ../evolution/multiplier32bit/NSGA-II/config1/multiplier32bit_result_6.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier32bit/NSGA-II/config1/multiplier32bit_result_6.txt
#----------------estimating critical path delay -------------------
