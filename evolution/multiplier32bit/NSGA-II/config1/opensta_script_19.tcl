...
read_verilog ../modules/netlist/NR_25_4.v
...
read_verilog ../modules/netlist/NR_25_25.v
read_verilog ../modules/netlist/NR_4_25.v
...
read_verilog ../modules/netlist/customAdder33_3.v
...
read_verilog ../circuits/multiplier32bit/NSGA-II/config1/multiplier32bit_19.v 


#identify the top module name
link_design multiplier32bit_19
...
#estimate power
report_power >> ../evolution/multiplier32bit/NSGA-II/config1/multiplier32bit_result_19.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier32bit/NSGA-II/config1/multiplier32bit_result_19.txt
#----------------estimating critical path delay -------------------
