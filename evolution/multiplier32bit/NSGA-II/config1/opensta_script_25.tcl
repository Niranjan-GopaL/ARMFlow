...
read_verilog ../modules/netlist/customAdder35_13.v
...
read_verilog ../circuits/multiplier32bit/NSGA-II/config1/multiplier32bit_25.v 


#identify the top module name
link_design multiplier32bit_25
...
#estimate power
report_power >> ../evolution/multiplier32bit/NSGA-II/config1/multiplier32bit_result_25.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier32bit/NSGA-II/config1/multiplier32bit_result_25.txt
#----------------estimating critical path delay -------------------
