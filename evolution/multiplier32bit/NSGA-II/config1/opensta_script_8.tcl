...
read_verilog ../modules/netlist/NR_16_6.v
read_verilog ../modules/netlist/NR_6_10.v
read_verilog ../modules/netlist/NR_6_16.v
...
read_verilog ../modules/netlist/customAdder32_4.v
...
read_verilog ../modules/netlist/customAdder38_15.v
...
read_verilog ../evolution/multiplier32bit/NSGA-II/config1/multiplier32bit_8.v 


#identify the top module name
link_design multiplier32bit_8
...
#estimate power
report_power >> ../evolution/multiplier32bit/NSGA-II/config1/multiplier32bit_result_8.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier32bit/NSGA-II/config1/multiplier32bit_result_8.txt
#----------------estimating critical path delay -------------------
