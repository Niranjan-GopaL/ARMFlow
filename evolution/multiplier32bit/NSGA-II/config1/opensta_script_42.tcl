...
read_verilog ../modules/netlist/NR_3_9.v
...
read_verilog ../modules/netlist/customAdder21_8.v
...
read_verilog ../modules/netlist/customAdder16_1.v
read_verilog ../modules/netlist/customAdder59_27.v
read_verilog ../modules/netlist/customAdder41_12.v
...
read_verilog ../circuits/multiplier32bit/NSGA-II/config1/multiplier32bit_42.v 


#identify the top module name
link_design multiplier32bit_42
...
#estimate power
report_power >> ../evolution/multiplier32bit/NSGA-II/config1/multiplier32bit_result_42.txt
...
#critical path delay
report_checks -unconstrained >> ../evolution/multiplier32bit/NSGA-II/config1/multiplier32bit_result_42.txt
#----------------estimating critical path delay -------------------
