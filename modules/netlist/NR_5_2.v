...
module NR_5_2(A, B, Product);
  ...
  unsignedBrentKungAdder4bit uut10 (
    .A({ P_0_4, P_0_3, P_0_2, P_0_1 }),
    .B({ P_1_3, P_1_2, P_1_1, P_1_0 }),
    .Sum({ Product[6], Product[4:1] })
  );
  AndGate uut2 (
    .a(A[2]),
    .b(B[0]),
  ...
  assign { Product[5], Product[0] } = { P_1_4, P_0_0 };
endmodule
