...
module NR_2_9(A, B, Product);
  ...
  unsignedBrentKungAdder8bit uut18 (
    .A({ P_7_1, P_6_1, P_5_1, P_4_1, P_3_1, P_2_1, P_1_1, P_0_1 }),
    .B({ P_8_0, P_7_0, P_6_0, P_5_0, P_4_0, P_3_0, P_2_0, P_1_0 }),
    .Sum({ Product[10], Product[8:1] })
  );
  AndGate uut2 (
    .a(A[0]),
    .b(B[1]),
  ...
  assign { Product[9], Product[0] } = { P_8_1, P_0_0 };
endmodule
